      ...
      <form onSubmit={handleSubmit} >
        ...
        <div className='flex flex-col justify-evenly'>
          <Input
            ...
            className={error.email ? 'border-red-500 border-2' : ''}
            type='text'
          ...
          <Input
            ...
            label='Password'
            labelClass={styles.labelText}
            className={error.password ? 'border-red-500 border-2' : styles.inputText}
            type='password'
        ...
        <div className='text-center pt-2'>
          <div className="text-sm text-red-600 mb-2"> {error.text} </div>
          <Button
            type="submit"
